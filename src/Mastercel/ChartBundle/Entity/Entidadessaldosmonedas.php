...
/**
 * Entidadessaldosmonedas
 *
 * @ORM\Table(name="EntidadesSaldosMonedas", indexes={@ORM\Index(name="Indice_20", columns={"DteActualizacion"}), @ORM\Index(name="Indice_30", columns={"NumEstadoComunicacion"})})
 * @ORM\Entity
 */
class Entidadessaldosmonedas
{
    /**
     * @var integer
     *
