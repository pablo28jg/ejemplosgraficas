 ...
 * Actividades
 *
 * @ORM\Table(name="Actividades", uniqueConstraints={@ORM\UniqueConstraint(name="Indice_1", columns={"StrActividad_ky"})}, indexes={@ORM\Index(name="Indice_10", columns={"NumNivel_5_id"}), @ORM\Index(name="Indice_11", columns={"NumNivel_6_id"}), @ORM\Index(name="Indice_12", columns={"NumNivel_7_id"}), @ORM\Index(name="Indice_13", columns={"NumNivel_8_id"}), @ORM\Index(name="Indice_14", columns={"NumNivel_9_id"}), @ORM\Index(name="Indice_15", columns={"NumNivel_10_id"}), @ORM\Index(name="Indice_16", columns={"NumEstadoComunicacion"}), @ORM\Index(name="Indice_2", columns={"StrDescripcion"}), @ORM\Index(name="Indice_3", columns={"DteActualizacion"}), @ORM\Index(name="Indice_4", columns={"NumJerarquia_id", "StrActividad_ky"}), @ORM\Index(name="Indice_5", columns={"NumOrden_id", "NumNivel_id"}), @ORM\Index(name="Indice_6", columns={"NumNivel_1_id"}), @ORM\Index(name="Indice_7", columns={"NumNivel_2_id"}), @ORM\Index(name="Indice_8", columns={"NumNivel_3_id"}), @ORM\Index(name="Indice_9", columns={"NumNivel_4_id"})})
 * @ORM\Entity
 */
class Actividades
{
     ...
     * @var string
     *
     * @ORM\Column(name="StrActividad_ky", type="string", length=10, nullable=true)
     */
    private $stractividadKy;
     ...
     * Set stractividadKy
     *
     * @param string $stractividadKy
     * @return Actividades
     */
    public function setStractividadKy($stractividadKy)
    {
        $this->stractividadKy = $stractividadKy;
     ...
     * @return string 
     */
    public function getStractividadKy()
    {
        return $this->stractividadKy;
    }
