...
/**
 * Cuentascontablessaldos
 *
 * @ORM\Table(name="CuentasContablesSaldos", indexes={@ORM\Index(name="Indice_1", columns={"NumEjercicio_id", "NumEmpresa_id", "NumCentroControl_id", "StrCuenta_ky"}), @ORM\Index(name="Indice_2", columns={"DteActualizacion"}), @ORM\Index(name="Indice_3", columns={"NumEstadoComunicacion"})})
 * @ORM\Entity
 */
class Cuentascontablessaldos
{
    /**
     * @var integer
     *
